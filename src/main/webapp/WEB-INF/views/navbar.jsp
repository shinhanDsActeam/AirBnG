    ...
    <div class="container">
        <nav class="bottom-nav">
            <a href="shopping-cart.jsp" class="nav-item" data-page="shopping-cart">
                <img src="${pageContext.request.contextPath}/resources/images/shopping-cart.svg" alt="보관소" class="nav-icon">
                <span class="nav-text">보관소</span>
            </a>

            <a href="messages.jsp" class="nav-item" data-page="messages">
                <img src="${pageContext.request.contextPath}/resources/images/messages.svg" alt="채팅" class="nav-icon">
                <span class="nav-text">채팅</span>
            </a>

            <a href="${pageContext.request.contextPath}/page/home" class="nav-item" data-page="home">
                <img src="${pageContext.request.contextPath}/resources/images/home.svg" alt="홈" class="nav-icon">
                <span class="nav-text">홈</span>
            </a>

            <a href="calendar.jsp" class="nav-item" data-page="calendar">
                <img src="${pageContext.request.contextPath}/resources/images/calendar.svg" alt="예약" class="nav-icon">
                <span class="nav-text">예약</span>
            </a>

            <a href="mypage.jsp" class="nav-item" data-page="mypage">
                <img src="${pageContext.request.contextPath}/resources/images/user.svg" alt="마이" class="nav-icon">
