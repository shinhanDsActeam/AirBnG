...
public enum BaseResponseStatus implements ResponseStatus{
    ...
    DUPLICATE_JIMTYPE(3003, HttpStatus.BAD_REQUEST.value(), "중복된 짐 타입이 존재합니다."),
    ...
    INVALID_RESERVATION_PARTICIPANTS(4003, HttpStatus.NOT_FOUND.value(), "예약자와 보관자는 동일할 수 없습니다."),
